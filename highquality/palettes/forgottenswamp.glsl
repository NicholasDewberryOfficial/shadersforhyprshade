...
void main() {
    ...
    //not sure why
    solarized[0] = vec3(0.820, 0.678, 0.631); // #d1ada1
    solarized[1] = vec3(0.302, 0.490, 0.396); // #4d7d65
    solarized[2] = vec3(0.349, 0.227, 0.373); // #593a5f
    solarized[3] = vec3(0.231, 0.145, 0.180); // #3b252e
