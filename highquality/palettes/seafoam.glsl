...
void main() {
    ...
    //not sure why
    solarized[0] = vec3(0.216, 0.212, 0.306);
    solarized[1] = vec3(0.208, 0.365, 0.412);
    solarized[2] = vec3(0.416, 0.682, 0.616);
    solarized[3] = vec3(0.725, 0.831, 0.706);
    solarized[4] = vec3(0.957, 0.914, 0.831);
    solarized[5] = vec3(0.816, 0.729, 0.663);
    solarized[6] = vec3(0.620, 0.557, 0.569);
    solarized[7] = vec3(0.357, 0.290, 0.408);
