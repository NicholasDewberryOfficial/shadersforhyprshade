...
void main() {
	...
	solarized[1] = vec3(0.2,0.1,0.1);
	solarized[2] =  vec3(0.3,0.1,0.1);
	solarized[3]  = vec3(0.4,0.1,0.1);
	solarized[4]  = vec3(0.5,0.1,0.1);
	solarized[5]  = vec3(0.6,0.1,0.1);
	solarized[6]  = vec3(0.7,0.1,0.1);
	solarized[7]  = vec3(0.8,0.1,0.1);
	solarized[8]  = vec3(0.9,0.1,0.1);
	solarized[9]  = vec3(1.0,0.1,0.1);
